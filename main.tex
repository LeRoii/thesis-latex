...
\documentclass[
    doctor,   % 必选项：   {bachelor,master, doctor} 此处不区分专业/学术学位，在下面学科类型处区分
...
\title{多光谱融合智能光电处理算法与系统设计}{Intelligent Electro-Optical Processing Algorithm and Systems Design based on Multispectral Fusion}
...
\subject{控制科学与工程}{Control Science and Technology}
...
\addcommitteemember{西安交通大学,辛景民,教授}
\addcommitteemember{西北工业大学,王鹏,教授}
\addcommitteemember{西安电子科技大学,董伟生,教授}
\addcommitteemember{西安交通大学,魏平,教授}
\addcommitteemember{西安交通大学,杜少毅,教授}


% 答辩时间（手动指定）
% Defence date, input manually
\defensedate{2023}{05}{14}

% 答辩地点（涉密论文请手动设置为「西安交通大学」）
% Defence location, default value is 「西安交通大学」
\defenseloc{西安交通大学科学馆324}
...
\addgeneralreviewer{西安交通大学,魏平,教授}
\addgeneralreviewer{西安电子科技大学,邓成,教授}
% \addgeneralreviewer{XXXX大学,XX,教授}
